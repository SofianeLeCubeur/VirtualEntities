...
import com.github.sofianelecubeur.virtualentities.nms.Reflection.FieldAccessor;
import com.github.sofianelecubeur.virtualentities.nms.Reflection.MethodInvoker;
...
public abstract class TinyProtocol {
     ...
     * @param players - the destination players
     * @param packet - the packet to send
     */
    public void sendPacket(Collection<Player> players, Object packet) {
        players.forEach(player -> sendPacket(getChannel(player), packet));
    }
     ...
     */
    public void sendPacket(Collection<Player> players, Object... packets) {
        players.forEach(player -> {
            Channel ch = getChannel(player);
            Arrays.asList(packets).forEach(packet -> sendPacket(ch, packet));
        });
    }
